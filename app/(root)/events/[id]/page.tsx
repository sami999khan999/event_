      ...
      <section className="flex justify-center bg-primary-50 bg-dotten-pattern bg-contain">
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl">
          <Image
            ...
            width={1000}
            height={1000}
            className="h-full mid-h-[300px] object-cover object-center"
          />
          <div className="flex w-full flex-col gap-8 p-5 md:p-10">
            ...
            <div className="flex flex-col gap-5">
              <div className="flex gap-2 ">
                <Image
                  ...
                  height={32}
                />
                <div className="p-medium-20 lg:p-regular-20 flex flex-wrap items-center sm:flex-col">
                  <p>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="p-medium-16 lg:regular-18 truncate text-primary-500 underline">
                {event.url}
              </p>
            </div>
          </div>
